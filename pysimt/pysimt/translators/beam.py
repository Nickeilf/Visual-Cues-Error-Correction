...
class BeamSearch:
    def __init__(self, model, data_loader, out_prefix, batch_size, filter_chain=None,
        ...
        # self.vocab = self.model.cor_vocab
    ...
    def decoder_step(self, state_dict, next_word_idxs, h, hypothesis=None):
        ...
        # hardcode to generate corrections, this is dirty =.=
        # logp, h = self.model.dec_cor.f_next(
        #     state_dict, self.model.dec_cor.get_emb(next_word_idxs), h, hypothesis)
    ...
    def decoder_init(self, state_dict=None):
        ...
        # return self.model.dec_cor.f_init(state_dict)
    ...
    def run(self, **kwargs):
        ...
        for batch in progress_bar(self.data_loader, unit='batch'):
            ...
            # h_gs = self.decoder_init(state_dict_gs)
            ...
            # next_word_idxs_gs = self.model.get_bos(cur_batch_size).to(DEVICE)
            ...
            # tf_decoder_input_gs = next_word_idxs.clone().unsqueeze(0)
            ...
            for t in range(self.max_len):
                ...
                # logp_gs, h_gs, next_word_idxs_gs = self.decoder_step_gs(
                #     state_dict_gs, next_word_idxs_gs, h_gs, tf_decoder_input_gs)
                
                # hyps_gs[t, :cur_batch_size] = next_word_idxs_gs
                # tf_decoder_input_gs = torch.cat((tf_decoder_input_gs, next_word_idxs_gs.unsqueeze(0)), dim=0)
                ...
                # print("After concat")
                # print("next", next_word_idxs)
                # print(tf_decoder_input)

                # print("="*50)
                # print("t=", str(t))
                # print(logp_gs.topk(1, sorted=False, largest=True))
                # print(logp.topk(1, sorted=False, largest=True))

                # print(next_word_idxs_gs)
                # print(next_word_idxs)

                # print(tf_decoder_input_gs)
                # print(tf_decoder_input)
