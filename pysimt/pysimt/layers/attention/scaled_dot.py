...
class ScaledDotAttention(torch.nn.Module):
    ...
    def reset_parameters(self):
        # from Fairseq
        nn.init.xavier_uniform_(self.lin_k.weight, gain=1 / math.sqrt(2))
        nn.init.xavier_uniform_(self.lin_q.weight, gain=1 / math.sqrt(2))
        nn.init.xavier_uniform_(self.lin_v.weight, gain=1 / math.sqrt(2))
