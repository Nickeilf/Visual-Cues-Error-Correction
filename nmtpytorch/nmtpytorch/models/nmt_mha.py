...
from ..layers import TextEncoder, MultiHeadAttention
...
class MHANMT(nn.Module):
    ...
    def setup(self, is_train=True):
        ...
        self.mha = MultiHeadAttention(model_dim=self.enc.ctx_size,
                                        n_heads=self.opts.model['n_heads'],
                                        dropout=self.opts.model['dropout_mha'],
                                        with_image=False)
